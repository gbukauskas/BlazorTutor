...
*/
        ...
        public void PreparePaging(string argument, NavigationManager navManager, string baseUrl, int pageNumber)
        {
            ...
            if (int.TryParse(argument, out int pageSize)) // this.PagerState.PageSize has default value if parsing fails.
            {
...
// Remove reference from customers
        ...
        public void PrepareFiltering(NavigationManager navManager)
        {
            ...
            this.FilterState = new Tuple<string, string, string?, bool, bool>(fieldName, searchValue, "", false, false);
        }
        ...
        public static explicit operator AppState(StateForComponent currentState)
        {
            ...
            var rzlt = new AppState()
            {
                ...
                FilterIsDateValue = currentState.FilterState.Item4 ? (byte)1 : 
                                        (currentState.FilterState.Item5 ? (byte)2 : (byte)0),
