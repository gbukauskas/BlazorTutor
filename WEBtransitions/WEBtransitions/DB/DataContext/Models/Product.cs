...
public partial class Product
{
    ...
    internal static void Configure(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.Property(e => e.UnitsInStock).HasDefaultValue(0).HasColumnType("INTEGER");
            entity.Property(e => e.UnitsOnOrder).HasDefaultValue(0).HasColumnType("INTEGER");
            entity.Property(e => e.ReorderLevel).HasDefaultValue(0).HasColumnType("INTEGER");
