...
namespace ClassLibraryDatabase.DB_Context
{
    public partial class NorthwindContext: DbContext
    {
        ...
        /// <summary>
        /// Creates WEBtransitions_DBContext for testing environment
        /// </summary>
        ...
        public static NorthwindContext CreateDBcontext(string connectionString)
        {
            ...
            var optionsBuilder = new DbContextOptionsBuilder<NorthwindContext>();   // see https://stackoverflow.com/questions/50788272/how-to-instantiate-a-WEBtransitions_DBContext-in-ef-core
