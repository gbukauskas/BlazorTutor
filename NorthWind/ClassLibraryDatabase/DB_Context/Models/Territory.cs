...
#pragma warning restore CS8618
        ...
        /// </summary>
        public virtual ICollection<Employee> Employees { get; set; } = Array.Empty<Employee>();     // new List<Employee>();
        ...
        internal static void Configure(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Territory>(entity =>
            {
                ...
                object value = entity.HasOne(d => d.Region).WithMany(p => p.Territories)
